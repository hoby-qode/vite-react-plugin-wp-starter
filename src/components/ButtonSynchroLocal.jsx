...
import data from '../../public/listFilmWithLastInfo.json' // Importe directement le fichier JSON

const ButtonSynchroLocal = ({ onChangeData, prevData }) => {
  ...
  return (
    <Button onClick={lanceSynchro}>
      {pending ? 'Chargement...' : 'Synchronisation locale'}&nbsp;
      {progress != 0 ? progress + ' %' : ''}
    </Button>
  )
}

export default ButtonSynchroLocal
